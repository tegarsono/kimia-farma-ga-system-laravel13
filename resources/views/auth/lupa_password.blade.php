...
<head>
    ...
    <title>Lupa Password | GA Management KFA</title>
        ...
        <div class="glass-effect rounded-3xl shadow-2xl overflow-hidden border border-white/20">
            ...
            <div class="p-8 pb-4 text-center">
                <div class="inline-flex items-center justify-center w-20 h-20 bg-indigo-600 rounded-2xl shadow-lg mb-5 transform -rotate-6">
                    <i class="fas fa-key text-white text-4xl rotate-6"></i>
                </div>
                <h2 class="text-2xl font-extrabold text-gray-800">Lupa Password</h2>
                <p class="text-gray-500 mt-1 text-sm">Reset password akun Anda dengan kode OTP</p>
            </div>
            ...
            {{-- Form --}}
            <form method="POST" action="{{ route('password.sendOtp') }}" class="p-6 pt-4 space-y-4 animate-slideIn">
                @csrf
                <div class="space-y-1.5">
                    <label class="text-sm font-semibold text-gray-600 ml-1">Email Terdaftar</label>
                    <div class="relative group">
                        <i class="fas fa-envelope absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-indigo-600 transition-colors"></i>
                    ...
                    <p class="text-xs text-gray-400 ml-1">Masukkan email yang terdaftar di akun Anda</p>
                </div>
                <button type="submit"
