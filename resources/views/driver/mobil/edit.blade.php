...
@section('page-title','Edit Data Armada Mobil')

@section('content')
<div class="row justify-content-center"><div class="col-12 col-md-6">
<div class="card">
    <div class="card-header"><i class="fas fa-edit me-2 text-warning"></i>Edit — {{ $mobil->merk }}</div>
    <div class="card-body">
        @if($errors->any())<div class="alert alert-danger"><ul class="mb-0">@foreach($errors->all() as $e)<li>{{ $e }}</li>@endforeach</ul></div>@endif
        <form method="POST" action="{{ route('driver.mobil.update', $mobil->id_mobil) }}">
            @csrf @method('PUT')
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="plat_nomor" class="form-control" value="{{ old('plat_nomor', $mobil->plat_nomor) }}"
            ...
            <div class="mb-3">
                ...
                <input type="text" name="tipe_mobil" class="form-control" list="tipeList"
                    value="{{ old('tipe_mobil', $mobil->tipe_mobil) }}" required>
