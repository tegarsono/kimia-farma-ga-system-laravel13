...
@section('page-title','Tambah Item ATK')
...
<div class="container-fluid py-3">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="mb-1"><i class="fas fa-plus-circle me-2"></i>Tambah Item ATK</h2>
            <p class="text-muted mb-0">Masukkan detail lengkap barang ATK baru</p>
        </div>
    ...
    <div class="card shadow-sm">
        <div class="card-header bg-primary text-white">
            <h5 class="mb-0"><i class="fas fa-edit me-2"></i>Formulir Data Barang</h5>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ route('ga.atk.store') }}">
                @csrf
                {{-- Status default Masuk (hidden) --}}
                <input type="hidden" name="status_barang" value="Masuk">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea class="form-control" id="spesifikasi" name="spesifikasi" rows="3"
                            placeholder="Contoh: Ukuran A4, 80 gram, 500 lembar/rim">{{ old('spesifikasi') }}</textarea>
                    </div>
                ...
                <div class="d-flex justify-content-end pt-4 mt-3 border-top">
                    ...
                    <button type="submit" class="btn btn-success">
                        <i class="fas fa-save me-1"></i> Simpan Data ATK
                    </button>
                </div>
            </form>
        </div>
